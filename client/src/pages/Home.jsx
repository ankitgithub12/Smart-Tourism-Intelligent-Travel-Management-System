...
const Home = () => {
  ...
  return (
    <div className="overflow-hidden bg-white text-gray-900">
      {/* ═══════ HERO SECTION ═══════ */}
      <section className="relative min-h-[96vh] flex items-center justify-center pt-20 pb-16 overflow-hidden bg-gradient-to-br from-blue-600 to-blue-800">
        {/* Gradient Background */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm text-white text-xs font-black tracking-wider uppercase mb-8"
          >
            <Sparkles size={14} /> Smart Travel Platform
          </motion.div>
          ...
          >
            Powered by advanced AI. Custom design your hotels, transport, and experiences with real-time tracking and smart recommendations.
          </motion.p>
          ...
          >
            <form 
              ...
              className="grid grid-cols-1 md:grid-cols-12 gap-3.5 p-4 bg-white rounded-3xl shadow-lg shadow-blue-200"
            >
              {/* FROM */}
              <div className="col-span-1 md:col-span-3 flex flex-col items-start bg-blue-50 rounded-2xl px-4 py-3 border border-blue-200 focus-within:border-blue-500 transition-all text-left">
                <span className="text-[10px] font-extrabold text-blue-600 uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                  <MapPin size={11} /> Departure point
                </span>
                <input 
                  type="text" 
              ...
              {/* DATE */}
              <div className="col-span-1 md:col-span-2 flex flex-col items-start bg-blue-50 rounded-2xl px-4 py-3 border border-blue-200 focus-within:border-blue-500 transition-all text-left">
                <span className="text-[10px] font-extrabold text-blue-600 uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                  <Calendar size={11} /> Departure Date
                </span>
                <input 
                  type="date" 
                  min={today}
              ...
              <button 
                type="submit"
                className="col-span-1 md:col-span-2 flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-4 rounded-2xl font-bold text-sm active:scale-95 transition-all shadow-lg shadow-blue-200 cursor-pointer"
              >
      ...
      <section className="relative z-20 py-8 px-6 -mt-10 max-w-7xl mx-auto">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="p-6 rounded-3xl bg-blue-50 border border-blue-200 shadow-md flex flex-col lg:flex-row justify-between items-center gap-6"
        >
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-2xl bg-blue-100 flex items-center justify-center border border-blue-200 text-blue-600">
              <Activity size={24} className="animate-pulse" />
            </div>
            <div className="text-left">
              <h4 className="font-extrabold text-sm flex items-center gap-1.5 text-gray-900">
                Smart City Analytics <span className="text-[9px] font-black uppercase text-blue-600 bg-blue-100 px-2 py-0.5 rounded">Live</span>
              </h4>
              <p className="text-xs text-gray-600">Real-time tourism and environmental impact metrics.</p>
            </div>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-12 w-full lg:w-auto">
            <div className="text-left md:border-l md:border-blue-200 md:pl-6">
              <p className="text-[10px] text-gray-600 uppercase font-black tracking-wider mb-1">Live Tourists</p>
              <p className="text-lg font-black text-blue-600">{mockTelemetry.activeTourists.toLocaleString()}</p>
            </div>
            <div className="text-left border-l border-blue-200 pl-6">
              <p className="text-[10px] text-gray-600 uppercase font-black tracking-wider mb-1">Eco Score</p>
              <p className="text-lg font-black text-green-600">{mockTelemetry.ecoScore}/100</p>
            </div>
            <div className="text-left border-l border-blue-200 pl-6">
              <p className="text-[10px] text-gray-600 uppercase font-black tracking-wider mb-1">Carbon Saved</p>
              <p className="text-lg font-black text-blue-600">{mockTelemetry.carbonSaved}</p>
            </div>
            <div className="text-left border-l border-blue-200 pl-6">
              <p className="text-[10px] text-gray-600 uppercase font-black tracking-wider mb-1">Traffic status</p>
              <p className="text-lg font-black text-green-600 flex items-center gap-1">
                <span className="w-1.5 h-1.5 rounded-full bg-green-500 inline-block animate-ping" /> {mockTelemetry.transitStatus}
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-blue-600 font-extrabold text-xs uppercase tracking-widest mb-3">Key Features</p>
            <h2 className="text-3xl md:text-5xl font-black text-gray-900">Powerful AI-Driven Features</h2>
            <p className="text-gray-600 text-sm max-w-xl mx-auto mt-4 leading-relaxed">
              Everything you need for a seamless, personalized travel experience backed by real-time data.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feat, idx) => (
              <motion.div 
                ...
                className="p-7 rounded-3xl bg-white border border-gray-100 hover:shadow-lg transition-all duration-300 group"
              >
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-4">
            <div>
              <p className="text-blue-600 font-extrabold text-xs uppercase tracking-widest mb-3">Popular Places</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {destinations.map((place, idx) => (
              <motion.div 
                ...
                className="rounded-3xl overflow-hidden bg-white border border-gray-100 hover:shadow-lg transition-all group"
              >
                <div>
                  <div className="relative h-56 overflow-hidden">
                    ...
                    <span className="absolute top-3 left-3 px-3 py-1 rounded-full text-[9px] font-black uppercase bg-white text-blue-600 tracking-widest">
                      {place.type}
                    </span>

                    <div className="absolute top-3 right-3 bg-white px-2.5 py-1 rounded-full text-[10px] font-black text-amber-500 flex items-center gap-1">
                    ...
                    <div className={`absolute bottom-3 left-3 text-[9px] font-extrabold px-3 py-1 rounded-full flex items-center gap-1 border ${crowdColors[place.crowdLevel]}`}>
                      <Users size={10} /> {place.crowdLevel}
                    </div>
                  </div>

                  <div className="p-4">
                    <p className="text-blue-600 text-[10px] font-black uppercase tracking-wider flex items-center gap-1 mb-1.5">
                      <MapPin size={11} /> {place.location}
                    </p>
                    <h3 className="font-extrabold text-base mb-3 text-gray-900 group-hover:text-blue-600 transition-colors">{place.name}</h3>
                    
                    <div className="flex gap-1.5 flex-wrap">
                      {place.tags.map((t, i) => (
                        <span key={i} className="text-[8px] font-bold text-gray-600 uppercase bg-blue-50 px-2 py-0.5 rounded">
                          {t}
                        </span>
                      ))}
                    </div>
                    ...
                    <Link 
                      to="/destinations" 
                      className="inline-block mt-4 text-xs text-blue-600 font-extrabold hover:text-blue-700 transition-colors"
                    >
                      View Details →
                    </Link>
                  </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-blue-600 font-extrabold text-xs uppercase tracking-widest mb-3">Success Stories</p>
            <h2 className="text-3xl md:text-5xl font-black text-gray-900">What Users Say</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-8 rounded-3xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-all">
              <div>
                <Quote size={32} className="text-blue-600 opacity-30 mb-6" />
                <p className="text-gray-700 text-sm leading-relaxed mb-8 font-medium">
                  "The smart itinerary planner saved me hours. Everything was perfectly customized and the prices were transparent!"
                </p>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-600 uppercase tracking-wider">Solo Traveler</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-all">
              <div>
                <Quote size={32} className="text-blue-600 opacity-30 mb-6" />
                <p className="text-gray-700 text-sm leading-relaxed mb-8 font-medium">
                  "The real-time tracking for tours and vehicles made managing our travel agency so much easier. Highly professional!"
                </p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center font-bold text-sm text-white">
                  RK
                </div>
                <div>
